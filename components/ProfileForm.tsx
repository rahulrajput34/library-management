...
export default function ProfileForm({
  ...
  return (
    <form
      action={formAction}
      className="max-w-lg mx-auto space-y-6 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-lg border border-gray-200 dark:border-neutral-700 shadow-xl rounded-2xl p-8"
    >
      {/* Full Name */}
